    ...
    <div className="container mx-auto px-4 py-8 bg-white text-gray-900">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-4">
            <Link href="/admin/trading">
              <button className="px-4 py-2 rounded transition-colors duration-200 bg-blue-600 text-white hover:bg-blue-700">
                Trading Control
              </button>
            </Link>
            <Link href="/admin/intraday-scheduler">
              <button className="px-4 py-2 rounded transition-colors duration-200 border bg-gray-100 text-gray-900 border-gray-300 hover:bg-gray-200">
                ⏰ Intraday Scheduler
              </button>
            </Link>
            ...
            <Link href="/admin/cleanup">
              <button className="px-4 py-2 rounded transition-colors duration-200 border bg-red-600 text-white border-red-600 hover:bg-red-700">
                🧹 Database Cleanup
              </button>
            </Link>
          </div>
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 bg-white border border-gray-200">
            <div className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-600">Total Users</div>
            </div>
            <div className="text-2xl font-bold mt-2 text-gray-900">{stats.totalUsers || 0}</div>
          </div>
          ...
          <div className="p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 bg-white border border-gray-200">
            ...
            <div className="text-2xl font-bold text-green-600 mt-2">{stats.activeUsers || 0}</div>
          </div>

          <div className="p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 bg-white border border-gray-200">
            <div className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-600">Suspended/Restricted</div>
            </div>
          ...
          <div className="p-6 rounded-lg shadow hover:shadow-lg transition-all duration-300 bg-white border border-gray-200">
            <div className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-600">Zerodha Connected</div>
            </div>
            <div className="text-2xl font-bold text-blue-600 mt-2">{stats.zerodhaConnectedUsers || 0}</div>
          </div>
        </div>
      )}

      {/* User Management Table */}
      <div className="rounded-lg shadow transition-all duration-300 bg-white border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-900">User Management</h2>
          <p className="mt-1 text-gray-600">View and manage all registered users</p>
        </div>
        <div className="p-6">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left p-2 text-gray-900">User</th>
                  <th className="text-left p-2 text-gray-900">Role</th>
                  <th className="text-left p-2 text-gray-900">Status</th>
                  <th className="text-left p-2 text-gray-900">Zerodha</th>
                  <th className="text-left p-2 text-gray-900">Active Bots</th>
                  <th className="text-left p-2 text-gray-900">Joined</th>
                  <th className="text-left p-2 text-gray-900">Actions</th>
                </tr>
              </thead>
              <tbody>
                {users.map((user) => (
                  <tr key={user._id} className="border-b border-gray-200 transition-colors duration-200 hover:bg-gray-50">
                    <td className="p-2">
                      <div>
                    ...
                    <td className="p-2">
                      <div className="flex space-x-2">
                        ...
                        {user.status === 'active' ? (
                          <button
                            className="px-3 py-1 text-xs border rounded transition-colors duration-200 border-gray-300 text-gray-900 bg-transparent hover:bg-gray-100"
                        ...
                        <button
                          className="px-3 py-1 text-xs border rounded transition-colors duration-200 border-red-300 text-red-600 hover:bg-red-50"
          ...
          <div className="flex justify-between items-center mt-4">
            ...
            <div className="flex space-x-2">
              <button
                className="px-3 py-1 text-xs border rounded transition-colors duration-200 border-gray-300 text-gray-900 bg-transparent hover:bg-gray-100 disabled:opacity-50"
